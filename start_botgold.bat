...
powershell -NoProfile -Command "if (-not (Get-CimInstance Win32_Process -Filter \"Name='python.exe'\" | Where-Object {$_.CommandLine -like '*bot.py*'})) { Start-Process python -ArgumentList 'bot.py' -WorkingDirectory 'C:\Users\NLope\Documents\repolocal-claude\botgold-ms' -WindowStyle Hidden }"
